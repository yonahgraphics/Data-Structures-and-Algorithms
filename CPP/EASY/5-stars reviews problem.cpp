...
int  min_reviews(int num_review, int num_5star_reviews, float target_percentage) {
    int count = 0;
...
#include <cmath>  // We need this import because we might get a floating point number and have to round it up

int min_reviews_better(int b, int a, float c) {
...
// Sample call to functions
        std::cout<<min_reviews(16, 10, 72)<<std::endl;
        std::cout<<min_reviews_better(16, 10, 72)<<std::endl;
        return 0;
    }
